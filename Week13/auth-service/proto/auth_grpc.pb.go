...
func (c *authServiceClient) GetUserById(ctx context.Context, in *GetUserRequest, opts ...grpc.CallOption) (*GetUserResponse, error) {
...
func (UnimplementedAuthServiceServer) GetUserById(context.Context, *GetUserRequest) (*GetUserResponse, error) {
